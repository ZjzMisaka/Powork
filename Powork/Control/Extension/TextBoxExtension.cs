...
namespace Powork.Control.Extension
{
    public class TextBoxExtension : DependencyObject
    {
        ...
        public static DependencyProperty IsFocusedProperty = DependencyProperty.RegisterAttached("IsFocused", typeof(bool), typeof(TextBoxExtension), new UIPropertyMetadata(false, OnIsFocusedChanged));
